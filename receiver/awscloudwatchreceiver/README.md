...
| `auth`          | *optional* | string    | The ID of an `awscredentialsprovider` extension to resolve AWS credentials centrally (static keys, profile, or STS assume-role) instead of the default SDK credential chain. |
